...
document.addEventListener('DOMContentLoaded', function () {
  ...
  homeLink.onclick = function () {
    document.querySelector('.simulation-app').style.display = 'none';
  ...
  // Show the simulation section when the Start button is clicked
  ...
  simulationStartButton.onclick = function () {
    ...
    // Show the simulation app
    document.querySelector('.simulation-app').style.display = 'flex';
    document.body.classList.add('simulation-active');
    startSimulation();
  };

  // Home button in the simulation to go back
  const homeButton = document.querySelector('.home-button');
  homeButton.onclick = function () {
    // Hide the simulation app
    document.querySelector('.simulation-app').style.display = 'none';
    document.body.classList.remove('simulation-active');
    // Show main sections
    document.querySelectorAll('section').forEach(section => section.style.display = 'block');
